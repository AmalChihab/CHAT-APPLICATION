...
CREATE TABLE `amitie` (
  ...
  KEY `fk2_client` (`id_client2`),
  CONSTRAINT `fk1_client` FOREIGN KEY (`id_client1`) REFERENCES `client` (`idClient`),
  CONSTRAINT `fk2_client` FOREIGN KEY (`id_client2`) REFERENCES `client` (`idClient`)
...
INSERT INTO `amitie` VALUES (1,2),(1,3);
...
-- Dump completed on 2023-01-12 21:37:52
